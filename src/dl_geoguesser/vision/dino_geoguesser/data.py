...
def get_dino_transforms(model_name: str, image_size: int, augment: bool) -> transforms.Compose:
    """
...
def create_image_datasets(cfg: Dict, use_image_aug: bool) -> Tuple[Dataset, Dataset, Dataset, Dict[str, int]]:
    ...
    train_transform = get_dino_transforms(model_name, data_cfg.image_size, augment=use_image_aug)
    eval_transform = get_dino_transforms(model_name, data_cfg.image_size, augment=False)
